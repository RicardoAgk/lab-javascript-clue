...
/*function revealMystery(envelope){
    console.log(`${selectRandom(suspectsArray).firstName} ${selectRandom(suspectsArray).lastName} killed Mr. Boddy using the ${selectRandom(weaponsArray).name} in the ${selectRandom(roomsArray).name}!`);
}
